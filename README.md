...
- Turning on ambient sound requires one click somewhere on the page first — browsers block audio from starting completely silently, this is a browser policy, not a bug here
